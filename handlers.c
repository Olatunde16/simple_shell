 ...
 * to execute the
 * command specified in the args array. If the command is found and 
 * executed successfully,
 * the parent process waits for the child process to complete and 
 ...
 * and the subsequent
 *         elements are its arguments. The last element should be NULL as 
 * required by execvp().
 *
 * Return Value:
